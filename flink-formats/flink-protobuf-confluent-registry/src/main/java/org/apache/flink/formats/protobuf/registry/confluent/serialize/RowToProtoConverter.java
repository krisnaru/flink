...
/**
 * {@link RowToProtoConverter} can convert flink row data to binary protobuf message data by codegen process.
 */
public class RowToProtoConverter {
  ...
  public Message convertRowToProtoBinary(RowData rowData) throws Exception {
